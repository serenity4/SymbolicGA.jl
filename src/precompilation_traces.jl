...
precompile(Tuple{typeof(SymbolicGA.builtin_bindings), SymbolicGA.Signature{3, 0, 0}})
precompile(Tuple{typeof(Core.kwcall), NamedTuple{(:warn_override,), Tuple{Bool}}, typeof(SymbolicGA.builtin_bindings), SymbolicGA.Signature{4, 1, 0}})
...
precompile(Tuple{typeof(SymbolicGA.builtin_bindings), SymbolicGA.Signature{4, 1, 0}})
...
precompile(Tuple{typeof(SymbolicGA.builtin_bindings), SymbolicGA.Signature{1, 1, 1}})
